...
```{r}
SON_full$Year <- rownames(SON_full)
```

```{r}
ggplot() + geom_bar(SON_full, mapping = aes(x = Year,y = SOM3), stat='identity')+geom_line(SON_full, mapping = aes(x=Year, y=anom), group = 1, col = 'red')
```
